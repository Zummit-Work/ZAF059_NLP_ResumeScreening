...
# reading pdf folder
text = extract_text('/content/drive/MyDrive/Vasundhara_Kadekodi Data_Analyst.pdf')
...
with open("/content/drive/MyDrive/Resume_screening_paramesh/model_Pred.pkl", "rb") as f:
    model = pickle.load(f)

with open("/content/drive/MyDrive/Resume_screening_paramesh/vectorizer_Pred.pkl", "rb") as f:
